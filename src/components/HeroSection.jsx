...
import FootballNet from "@/components/FootballNet"
...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    tl.fromTo(
      wordsRef.current,
      { y: "110%", opacity: 0 },
      { y: "0%", opacity: 1, duration: 0.85, stagger: 0.08, ease: "power4.out" },
      "-=0.25"
    )
    tl.fromTo(
      subtitleRef.current,
          ...
          <div className="hidden md:flex items-end gap-0">
            <div className="flex-1 flex flex-col items-center">
                  ...
                  <div className="relative rounded-[6px] overflow-hidden bg-white border border-[#2d2d2d] flex flex-col shadow-inner">
                    ...
                    <div className="relative bg-paper">
                      ...
                      <div
                        ...
                        style={{
                          background: "linear-gradient(135deg, rgba(255,255,255,0.15) 0%, rgba(255,255,255,0) 50%, rgba(255,255,255,0) 80%, rgba(255,255,255,0.05) 100%)",
              ...
              <div className="relative flex flex-col items-center -mt-[3px] select-none pointer-events-none z-0">
                <div
                  ...
                  style={{
                    background: "linear-gradient(90deg, #d1d5db 0%, #f3f4f6 30%, #e5e7eb 50%, #d1d5db 70%, #9ca3af 100%)",
                  }}
                >
                  <div
                  ...
                  >
                    <div
                      className="w-full h-full rounded-full bg-gradient-to-b from-[#111112] to-[#242426] shadow-[inset_0_2px_4px_rgba(0,0,0,0.85)] border border-black/30"
                    />
                  </div>
                </div>
                ...
                <div
                  ...
                  style={{
                    background: "linear-gradient(90deg, #b8bbc2 0%, #e5e7eb 15%, #f3f4f6 50%, #d1d5db 85%, #9ca3af 100%)",
            ...
            >
              <div
                ...
                style={{
                  background: "linear-gradient(135deg, #2d2438 0%, #584b6b 25%, #181320 50%, #584b6b 75%, #2d2438 100%)",
                  boxShadow: "inset 0 1px 2px rgba(255,255,255,0.45), inset 0 -1px 2px rgba(0,0,0,0.8)",
                }}
              >
                <div
                  className="relative rounded-[1rem] p-[3px] bg-[#09070c]"
                  style={{
                    boxShadow: "inset 0 1px 1px rgba(255,255,255,0.12), inset 0 -1px 1px rgba(0,0,0,0.95)"
                  }}
                >
                  <div className="relative rounded-[0.8rem] overflow-hidden bg-black ring-[2px] ring-[#070608]">
                    ...
                    <div className="absolute top-0 left-0 right-0 z-30 flex items-center justify-between px-5 pt-2.5 pb-1 pointer-events-none select-none">
                      <span className="text-white text-[9px] font-semibold tracking-tight leading-none">9:41</span>
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-white text-[7px] font-bold tracking-tighter leading-none">5G</span>
                    ...
                    <div
                      className={`absolute top-2 left-1/2 -translate-x-1/2 z-40 bg-black rounded-full transition-all duration-500 flex items-center justify-between pointer-events-none select-none shadow-[0_4px_12px_rgba(0,0,0,0.5)] ${islandActive
                        ? "w-[88%] h-7 px-3.5"
                        : "w-20 h-4.5 px-2"
                        }`}
                      ...
                      {islandActive ? (
                        <div className="w-full flex items-center justify-between animate-fade-up px-0.5">
                          ...
                          <div className="flex gap-[1px] items-center h-2">
                            ...
                            <div className="w-[1px] h-2.5 bg-[#3bf073] rounded-full animate-pulse" style={{ animationDelay: '0.15s' }} />
                            <div className="w-[1px] h-1 bg-[#3bf073] rounded-full animate-pulse" style={{ animationDelay: '0.3s' }} />
                          </div>
                        </div>
                      ) : (
                    ...
                    <div
                      ...
                      style={{
                        background: "linear-gradient(135deg, rgba(255,255,255,0.18) 0%, rgba(255,255,255,0) 45%, rgba(255,255,255,0) 70%, rgba(255,255,255,0.05) 100%)",
                        mixBlendMode: "overlay"
                      }}
                    />
